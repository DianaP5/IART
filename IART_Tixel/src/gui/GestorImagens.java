...
public class GestorImagens {
	...
	{		
		try {
			imagens.put(TipoImagem.mar,ImageIO.read(getClass().getResource("/Imagens/mar1.jpg")));
			imagens.put(TipoImagem.background,ImageIO.read(getClass().getResource("/imagens/fundo.png")));
			imagens.put(TipoImagem.pecaJogador1,ImageIO.read(getClass().getResource("/imagens/Jogador1.png")));
			imagens.put(TipoImagem.pecaJogador2,ImageIO.read(getClass().getResource("/imagens/Jogador2.png")));
		} catch (IOException e) {
			e.printStackTrace(); 
		}
	}
